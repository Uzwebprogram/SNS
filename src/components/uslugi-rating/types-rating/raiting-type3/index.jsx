...
import ModalType1 from '../../../../assets/modal/modal3.1.png'
import ModalType2 from '../../../../assets/modal/modal3.2.png'
...
const RatingType3Modal = ({ handleOk2, handleCancel2, isModalOpen2 }) => {
    const { t } = useTranslation()
    return (
        <>
            <Modal width={1000} footer={false} open={isModalOpen2} onOk={handleOk2} onCancel={handleCancel2}>
                <div className={styles.modal_title_box}>
                    <h4>{t("UslugiRating.RatingType3.0")}</h4>
                    <hr />
                </div>
                <div className={styles.modal_content_wrapp}>
                    <p>{t("UslugiRating.RatingType3.6")}</p>
                    ...
                    <div className={styles.modal_card_wrap}>
                        ...
                        <Row className={styles.modal_card_row}>
                            <Col className={styles.modal_card_col} lg={6} md={12} sm={12}>
                                ...
                                <p>{t("UslugiRating.RatingType3.1")}</p>
                            </Col>
                            <Col className={styles.modal_card_col} lg={6} md={12} sm={12}>
                                <img src={ModalType2} alt="" />
                                <p>{t("UslugiRating.RatingType3.2")}</p>
                            </Col>
                            ...
                            <Col className={styles.struct_wrap_col} lg={6} md={12} sm={12}>
                                ...
                                <div className={styles.struct_wrap_col_item}>
                                    <ul>
                                        ...
                                        <li>
                                            <i class='bx bxs-right-arrow-alt'></i>
                                            <p>{t("UslugiRating.RatingType3.5")}</p>
                                        </li>
                                        <li>
                                            <i class='bx bxs-right-arrow-alt'></i>
                                        ...
                                        <li>
                                            <i class='bx bxs-right-arrow-alt'></i>
                                            <p>{t("UslugiRating.RatingType3.3")}</p>
                                        </li>
                                        <li>
                                            <i class='bx bxs-right-arrow-alt'></i>
                                            <p>{t("UslugiRating.RatingType3.4")}</p>
                                        </li>
                                    </ul>
                                </div>
                            </Col>
...
export default RatingType3Modal