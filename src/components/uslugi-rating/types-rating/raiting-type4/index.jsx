...
const RatingType4Modal = ({ handleOk3, handleCancel3, isModalOpen3 }) => {
    ...
    return (
        <>
            <Modal width={1000} footer={false} open={isModalOpen3} onOk={handleOk3} onCancel={handleCancel3}>
                <div className={styles.modal_title_box}>
                    <h4>{t("UslugiRating.RatingType4.0")}</h4>
                    <hr />
                </div>
                <div className={styles.modal_content_wrapp}>
                    <p>{t("UslugiRating.RatingType4.1")}</p>
...
export default RatingType4Modal